...
| TC-007 | Login invalid menampilkan pesan error | Isi email/password salah → submit | Pesan "Email atau password salah" tampil | Fungsional | `login.spec.js` |
...
| TC-VR-003 | Visual — state error login | Submit dengan kredensial salah → screenshot | Diff ≤ 2% | Visual Regression | `login.spec.js` |
...
| TC-VR-011 | Visual — halaman login setelah logout | Klik logout → screenshot | Diff ≤ 1% | Visual Regression | `admin.spec.js` |
...
| TC-VR-012 | Visual — halaman portal user full | Buka portal → screenshot full page | Diff ≤ 1% | Visual Regression | `portal.spec.js` |
| TC-VR-013 | Visual — form laporan tiket | Buka portal → screenshot | Diff ≤ 1% | Visual Regression | `portal.spec.js` |
| TC-VR-014 | Visual — pesan sukses setelah submit | Submit tiket → screenshot | Diff ≤ 2% | Visual Regression | `portal.spec.js` |
| TC-VR-015 | Visual — daftar status tiket (tabel) | Buka portal → scroll ke tabel → screenshot | Diff ≤ 2% | Visual Regression | `portal.spec.js` |
| TC-VR-016 | Visual — tampilan mobile 375×812 | Set viewport 375px → buka portal → screenshot | Diff ≤ 1% | Visual Regression | `portal.spec.js` |
